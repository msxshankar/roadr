...
export default function RootLayout({
  ...
  return (
    <html lang="en" suppressHydrationWarning className="selection:bg-teal-400 selection:text-black">
      <body className="app-body bg-[#090a0f] text-slate-100 antialiased min-h-screen">
        {children}
        <SpeedInsights />
      </body>
    </html>
