    ...
    <header className="theme-scope flighty-header safe-top fixed left-0 right-0 top-0 z-40 flex flex-wrap items-center justify-between gap-2 px-3 pb-2.5 sm:gap-4 sm:px-4 sm:pb-3 liquid-glass-header">
      ...
      <div className="flex items-center space-x-2.5">
        ...
        <div>
          <div className="flex items-center space-x-1.5 sm:space-x-2">
            <h1 className="font-display text-sm font-extrabold tracking-[0.2em] text-teal-300 sm:text-base">
              ROADR
            </h1>
            <span className="header-badge text-[9px] sm:text-[10px] font-mono px-1.5 sm:px-2 py-0.5 rounded-full bg-violet-950/60 text-violet-300 border border-violet-400/30">
              MAP-FIRST ROUTING
            </span>
          </div>
      ...
      <div className="flex items-center space-x-1.5 sm:space-x-3">
        ...
        <button
          ...
          className="header-action flex items-center space-x-1 text-[11px] sm:text-xs bg-white/5 hover:bg-white/10 text-gray-300 hover:text-white px-2.5 sm:px-3 py-1.5 sm:py-2 rounded-xl border border-white/10 transition-all active:scale-95 shrink-0"
        ...
        <button
          ...
          className={`header-action flex items-center space-x-1.5 text-[11px] sm:text-xs px-2.5 sm:px-3 py-1.5 sm:py-2 rounded-xl border transition-all active:scale-95 shrink-0 ${
            token
        ...
        <button
          ...
          className="header-action flex items-center gap-1.5 rounded-xl border border-white/10 bg-white/5 px-2.5 py-1.5 text-[11px] text-gray-300 transition-all hover:bg-white/10 hover:text-white sm:px-3 sm:py-2 sm:text-xs"
