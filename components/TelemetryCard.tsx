...
export default function TelemetryCard({
  ...
  return (
    <div className="theme-scope theme-panel liquid-glass rounded-2xl border border-white/10 p-4 text-gray-100 shadow-2xl animate-fade-in space-y-4 sm:p-5">
      ...
      {onStartPreview && <button type="button" onClick={onStartPreview} className="theme-primary-button flex w-full items-center justify-center space-x-2 rounded-xl px-4 py-3 text-xs font-extrabold tracking-wider transition-all hover:brightness-110 active:scale-[.98]"><Video className="h-4 w-4" /><span>Start 3D drive preview</span></button>}
