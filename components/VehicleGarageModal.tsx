          ...
          <div className="min-w-0 space-y-5">
            ...
            >
              <div className="flex items-start justify-between gap-3">
                <div><p className="text-xs font-semibold uppercase tracking-wider text-cyan-200">{selectedVehicle ? 'Edit car' : 'New car'}</p><p className="mt-0.5 text-[10px] text-gray-500">Numeric fields stay editable while you type, including leading zeroes.</p></div>
